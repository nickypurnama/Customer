        ...
        <div class="span6">
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <h5>Transport to SAP</h5>
                </div>
                <div class="widget-content nopadding">
                    <form class="form-horizontal" action="<?php echo site_url('customer/transport_extend'); ?>" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
                    <div class="control-group">
                        <label class="control-label">Account Group</label>
                        <div class="controls">
                            <input type="hidden" id="id_ex" name="id_ex" value="<?php echo $id_ex; ?>">
                            <select name="account_group" id="account_group" readonly="readonly" class="span11" placeholder="Account Group" onchange="getRecon();">
                                <option></option>
                                <?php
			  ...
			  <div id="div_rec">
                    ...
                    <div class="form-actions">
                        <input type="submit" value="TRANSPORT TO SAP" id="btnApprove" class="btn btn-success">
                    </div>
                </form>
                </div>
            </div>
                ...
                <div class="widget-content nopadding">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 30%;"><b>Sales Organization</b></td>
                                <td><?php echo $xsales_org1." - ".$txt_sales_org2; ?></td>
                            </tr>
