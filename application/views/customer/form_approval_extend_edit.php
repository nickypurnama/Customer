...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb">
        ...
        <a  href="#">Customer</a>
	<a class="current" href="#">Form Edit Approval Extend Customer</a>
    </div>
  </div>
    ...
    <div class="row-fluid">
        ...
        <div class="span6">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form class="form-horizontal" action="<?php echo site_url('customer/edit_approval_extend'); ?>" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
