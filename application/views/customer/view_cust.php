...
<div id="content">
  ...
  <div class="container-fluid">
	...
	<div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <table class="table table-bordered">
                    ...
                    <tbody>
			<tr>
                            <td style="width: 30%;"><b>ID Request</b></td>
                            <td><?php echo $id_cust; ?></td>
                        </tr>
			<tr>
            ...
            <div class="widget-content nopadding">
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                             <td style="width: 30%;"><b>Search1 / Search2</b></td>
	...
	<?php
	  ...
	  if($st_send == 0 and $st == '1' and ($user_create == $nikA or strpos($this->session->userdata('role'),'ADMINISTRATOR') !== false)) :
	?>
	<div class="form-actions">
            <a href='javascript:posting("<?php echo $id_cust; ?>")'><input type="button" value="POSTING" class="btn btn-success"></a>
        </div>
	<?php
	  endif;
	?>
