		...
		<tbody>
			...
			foreach($row as $a){
				...
				echo "<a class='btn btn-info btn-mini' href='".$urlView."'>View</a>
					...
					<a class='btn btn-danger btn-mini' href='javascript:hapus(\"$id_cust\");'>Delete</a>
					<a class='btn btn-success btn-mini' href='javascript:posting(\"$id_cust\",\"$company\",\"$dis_channel\",\"$division\");'>&nbsp;Posting&nbsp; &nbsp;</a>";
			    }elseif($a['ST_SEND'] == 1){
				echo "<a class='btn btn-info btn-mini' href='".$urlView."'>View</a>
					<button class='btn btn-mini'>Edit</button>
					<button class='btn btn-mini'>Delete</button>
					<a class='btn btn-inverse btn-mini' href='javascript:unposting(\"$id_cust\");'>Unposting</a>";
