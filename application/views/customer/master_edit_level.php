  ...
  <div id="content-header">
    <div id="breadcrumb">
        <a href="<?php echo site_url('home/index'); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
         <a  href="#">Master</a>
	<a class="current" href="#">Edit Level Approval</a>
    </div>
  </div>
    ...
    <div class="row-fluid">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <form class="form-horizontal" method="post" action="<?php echo site_url('customer/edit_level'); ?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
                    
                    <div class="control-group">
                        <label class="control-label">NIK</label>
                        <div class="controls">
                            <input type="text" value="<?php echo $nik; ?>" name="nik" id="nik" class="span11" readonly="readonly">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">NIK Approval (Accounting)</label>
                        <div class="controls">
                            <input type="text" name="app" value="<?php echo $app; ?>" id="app" class="span11">
                        </div>
                    </div>
