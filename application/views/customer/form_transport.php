...
<div id="content">
  ...
  <div class="container-fluid">
	...
	<div class="widget-box">
			...
			<tr>
                            <td style="width: 30%;"><b>Industry Code 1</b></td>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form method="post" action="<?php echo site_url('customer/transport_sap');?>" name="form_transport">
                    <input type="hidden" name="id_cust" id="id_cust" value="<?php echo $id_cust; ?>">
                    <div class="form-actions">
                        <input type="submit" id="btnApprove" value="TRANSPORT TO SAP" class="btn btn-success">
                    </div>
                </form>
            </div>
        </div>
