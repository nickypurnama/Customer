...
<div id="content">
  <div id="content-header">
	...
	<a class="current" href="#">Form Change Contact Person</a>
    </div>
  </div>
    ...
    <div class="row-fluid">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <form class="form-horizontal" method="post" action="<?php echo site_url('customer/save_change_cp'); ?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" data-date="01-02-2013" name="tgl_lahir" id="tgl_lahir" data-date-format="dd-mm-yyyy" class="datepicker" value="<?php echo $tgl_lahir_format; ?>"/>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" data-date="01-02-2013" name="tgl_register" id="tgl_register" data-date-format="dd-mm-yyyy" class="datepicker" value="<?php echo $tgl_register_format; ?>" />
                        </div>
                    </div>
                    <div class="control-group">
