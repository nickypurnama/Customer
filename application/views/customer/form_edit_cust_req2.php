...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb">
        <a href="<?php echo site_url('home/index'); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
         <a class="current" href="#">Form : Change Customer Request</a>
  ...
  <div class="container-fluid">
	...
	<div id="tab1" class="tab-pane active">
        <form  method="post" action="<?php echo site_url('customer/add_edit_customer_req'); ?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
            <div class="row-fluid">
            <div class="span12">
		      ...
		      <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="subject" value="" class="span6" id="subject" maxlength="30" placeholder="Subject">
                            </div>
                        </div>
                        <div class="control-group">
			...
			<div class="control-group">
                        ...
                        <div class="controls">
                            <select name="account_group" readonly="readonly" id="account_group" class="span6" placeholder="Account Group" onchange="getRecon();">
                                <option></option>
                                <?php
	...
	<div id="tab2" class="tab-pane"> <!--start tab 2-->
	  <div class="row-fluid">
		...
		<div class="control-group">
		    ...
		    <div class="controls">
                        <input type="hidden" name="cust_account" id="cust_account" value="<?php echo $xkunnr; ?>">
                        <input type="hidden" name="account_group" id="account_group" value="<?php echo $xaccount_group; ?>">
                        <input type="hidden" name="recon_account" id="recon_account" value="<?php echo $xrecon_account; ?>">
			...
			<input type="hidden" name="short_key" id="short_key" value="<?php echo $xshort_key; ?>" >
			<!--<input type="hidden" name="industry_code" id="industry_code" value="<?php echo $xindustry_code1; ?>" >-->
			<input type="hidden" name="sales_group" id="sales_group" value="<?php echo $xsales_group; ?>" >
			<input type="hidden" name="cust_price" id="cust_price" value="<?php echo $xcust_price; ?>" >
			<input type="hidden" name="cust_stat" id="cust_stat" value="<?php echo $xcust_stat; ?>" >
			<input type="hidden" name="account_ass" id="account_ass" value="<?php echo $xaccount_ass; ?>" >
			<input type="hidden" name="relevan" id="relevan" value="<?php echo $xrelevan; ?>" >
			<input type="hidden" name="order_prob" id="order_prob" value="<?php echo $xorder_prob; ?>" >
			
			<input type="hidden" name="con_tlp" id="con_tlp" value="<?php echo $xcon_tlp; ?>" >
			<input type="hidden" name="con_hp" id="con_hp" value="<?php echo $xcon_hp; ?>" >
			<input type="hidden" name="con_fax" id="con_fax" value="<?php echo $xcon_fax; ?>" >
			<input type="hidden" name="con_email" id="con_email" value="<?php echo $xcon_email; ?>" >
		    </div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<input type="text" value="<?php echo $xpostal_code; ?>" name="postalcode" class="span3" id="postalcode" placeholder="Postal Code" maxlength="5">
			  <input type="text" name="city" value="<?php echo $xcity; ?>" class="span3" id="city" placeholder="City" maxlength="35">
                          ...
                          <?php
                            if($xallowpos == "1"){
                                echo '<input type="checkbox" checked="checked" name="ck1" id="ck1" value="1" onchange="show_nielsen();"> Allow the data at POS
                                     <input type="hidden" name="ck1_h" id="ck1_h" value="1">';
                            }else{
                                 echo '<input type="checkbox" name="ck1" id="ck1" value="1" onchange="show_nielsen();"> Allow the data at POS
		...
		<div class="control-group">
		    <label class="control-label"><b>Telephone | Fax | Mobile Phone | Email (Primary)</b></label>
		    <div class="controls">
		...
		<div class="control-group">
		    ...
		    <div class="controls">
			<select name="industry_code" id="industry_code" class="span6" placeholder="Industry Code">
			  <option value="">-</option>
			  <?php
			    foreach($industry_code as $key6a => $ic){
			      if($key6a == 0 and !isset($ic['BRACO'])){
				  continue;}
				if($xindustry_code1 == $ic['BRACO']){
		  ...
		  <div class="span12"> <!--start span 4-->
			  ...
			  <div class="controls">
				...
				<option value='Mr. and Ms. '>Mr. and Mrs.</option>
			      ...
			      <input style="margin-left:4px;" type="text" maxlength="35" class="span4" name="firstname_cp" id="firstname_cp" placeholder="First Name">
				<input  type="text" class="span4" name="name_cp" maxlength="35" id="name_cp" placeholder="Name">
				<br/>
			  </div>
		      </div>
			  ...
			  <div class="controls">
			      <input type="text" class="span8" name="tlp_cp" id="tlp_cp" maxlength="16" placeholder="Telp">
			      <input type="text" class="span4" name="ext_cp" id="ext_cp" maxlength="4" placeholder="Ext.">
			  </div>
		      </div>
		      <div class="control-group">
			  ...
			  <div class="controls">
			      <input type="text" class="span6" maxlength="16" name="fax_cp" id="fax_cp" placeholder="Fax">
			      <input type="text" class="span6" maxlength="30" name="email_cp" id="email_cp" placeholder="Email">
			  </div>
		      </div>
		      ...
		      <br/><br/>
		      <input type="button" name="btnAdd" id="btnAdd" value="Add Contact Person" class="btn btn-primary pull-right">
		       ...
		       <select name="sales_office" id="sales_office"  class="span6" placeholder="Sales Office">
				...
				foreach($sales_office as $key11 => $sof){
				   ...
				   if($key11 == 0 and !isset($sof['VKBUR'])){
				    ...
				    if($xc == "2"){
					if($sof['VKBUR'] < "2003" and $sof['VKBUR'] >= "2000"){
