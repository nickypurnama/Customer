...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb">
        <a href="<?php echo site_url('home/index'); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
         <a class="current" href="#">Form Edit : Customer Edit Request</a>
  ...
  <div class="container-fluid">
	...
	<div id="tab1" class="tab-pane active">
        <form  method="post" action="<?php echo site_url('customer/edit_edit_customer_req'); ?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
            <div class="row-fluid">
            <div class="span12">
		      ...
		      <div class="control-group">
                      ...
                      <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="cust_account" readonly="readonly" value="<?php echo $xkunnr; ?>" class="span6" id="cust_account" maxlength="30" placeholder="Subject">
                            </div>
                        </div>
                        <div class="control-group">
	...
	<div id="tab2" class="tab-pane"> <!--start tab 2-->
	  <div class="row-fluid">
		...
		<div class="control-group">
			...
			<input type="hidden" name="id_edit" id="id_edit" value="<?php echo $xid_edit; ?>">
                        <input type="text" name="name1" value="<?php echo $xname1; ?>" class="span4" id="name1" placeholder="Name 1"  maxlength="35">
			<input type="text" name="nickname" value="<?php echo $xnickname; ?>" class="span4" id="nickname" placeholder="Last Name"  maxlength="16">
			<input type="text" name="name2" value="<?php echo $xname2; ?>" class="span4" id="name2" placeholder="Name 2"  maxlength="35">
		...
		<div class="control-group">
		    <label class="control-label"><b>Telephone | Fax | Mobile Phone</b></label>
		    <div class="controls">
		       ...
		       <select name="sales_office" id="sales_office"  class="span6" placeholder="Sales Office">
				...
				foreach($sales_office as $key11 => $sof){
				   ...
				   if($key11 == 0 and !isset($sof['VKBUR'])){
				    ...
				    $xc=substr($xcompany_code,0,1);
				    echo "Aaaa".$xsales_office;
				    if($xc == "2"){
