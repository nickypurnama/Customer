...
<div id="content">
  ...
  <div class="container-fluid">
	<form action='<?php echo site_url('customer/cust_history_filter'); ?>' method='POST'>
	<div class="row-fluid">
		
		<div class='span3'>
			<div class='control-group'>
				<label class="control-label"><b>Date Start
              </b></label>
					<div class="controls">
	...
	<div class="widget-box " style="margin-top: -30px;">
		...
		<thead>
		  <tr>
		      ...
		      <th style="width:5%;">ID Cust</th>
                      <th style="width:5%;">SAP ID</th>
