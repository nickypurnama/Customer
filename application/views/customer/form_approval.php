...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb">
        ...
        <a  href="#">Customer</a>
	<a  href="#">Approval</a>
	<a class="current" href="#">View Customer Request</a>
    </div>
  </div>
  ...
  <div class="container-fluid">
    ...
    <div class="span7">
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form class="form-horizontal" action="<?php echo site_url('customer/add_approval'); ?>" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
                    <div class="control-group">
                        <label class="control-label">Short Key</label>
                        <div class="controls">
                            <input type="text" readonly="readonly" name="short_key" id="short_key" class="span2" value="003" >
			    <input type="text" name="short_name" id="short_name" class="span5" readonly="readonly" value="Document date" >
                        </div>
                    </div>
		    <div class="control-group">
                        <label class="control-label">Cust.pric.proc.</label>
                        <div class="controls">
                            <input type="text" readonly="readonly" name="cust_price" id="cust_price" class="span2" value="1" >
                        </div>
                    </div>
		    <div class="control-group">
                        <label class="control-label">Cust.Stats.Grp</label>
                        <div class="controls">
			    <input type="text" name="cust_stat" id="cust_stat" class="span2" readonly="readonly" value="1" >
                        </div>
                    </div>
		    <div class="control-group">
                        <label class="control-label">Relevant For POD</label>
                        <div class="controls">
			    YES
			    <input type="hidden" name="relevant_pod" id="relevant_pod" class="span2" readonly="readonly" value="X" >
                        </div>
                    </div>
		    <div class="control-group">
                        <label class="control-label">Account Assignment</label>
                        <div class="controls">
			    <input type="text" readonly="readonly" name="account_ass" id="account_ass" class="span2" value="02" >
			    <input type="text" name="aag_name" id="aag_name" class="span5" readonly="readonly" value="Non Affiliasi Lokal" >
                        </div>
                    </div>
		    <div class="control-group">
                        <label class="control-label">Sales Group</label>
                        <div class="controls">
			    <input type="text" readonly="readonly" name="sales_group" id="sales_group" class="span2" value="000" >
			    <input type="text" name="sales_name" id="sales_name" class="span5" readonly="readonly" value="Common" >
                        </div>
                    </div>
		    <div class="control-group">
                        <label class="control-label">Industry Code 1</label>
                        <div class="controls">
			    <input type="text" readonly="readonly" name="industry_code" id="industry_code" class="span2" value="<?php echo $industry_code; ?>" >
			    <input type="text" name="industry_name" id="industry_name" class="span5" readonly="readonly" value="<?php echo $txt_industry_code; ?>" >
                        </div>
                    </div>
		    ...
		    <div class="control-group">
			  ...
			  <div id="div_rec">
                            ...
                            <input type="hidden" name="company" id="company" value="<?php echo $company_code; ?>" >
                        </div>
                    </div>
