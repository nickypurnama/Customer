...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb">
        ...
        <a  href="#">Customer</a>
	<a class="current" href="#">Form Approval Change Customer Request</a>
    </div>
  </div>
  ...
  <div class="container-fluid">
    ...
    <div class="span7">
        <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form class="form-horizontal" action="<?php echo site_url('customer/edit_approval_edit'); ?>" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
