  ...
  <div class="container-fluid">
    ...
    <div class="span7">
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form class="form-horizontal" action="<?php echo site_url('customer/edit_approval'); ?>" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
		    ...
		    <div class="control-group">
                        ...
                        <div class="controls">
			    <input type="text" readonly="readonly" name="industry_code" id="industry_code" class="span2" value="<?php echo $xindustry_code; ?>" >
                        </div>
                    </div>
		    <div class="control-group">
