...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb">
        <a href="<?php echo site_url('home/index'); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
         <a class="current" href="#">Form Customer</a>
    </div>
  </div>
  ...
  <div class="row-fluid">
	...
	<form  method="post" action="<?php echo site_url('customer/add_customer'); ?>" name="basic_validate" id="basic_validate" novalidate="novalidate">
	...
	<div id="tab1" class="tab-pane active">
            ...
            <div class="span12">
		      ...
		      <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="subject" class="span6" id="subject" placeholder="Subject" maxlength="30">
				<div id="sts">
				  <input type="hidden" name="st_send"  id="st_send" value="0">
				</div>
	...
	<div id="tab2" class="tab-pane"> <!--start tab 2-->
	  <div class="row-fluid">
		...
		<div class="control-group">
		    ...
		    <div class="controls">
			<input type="text" name="name1" class="span6" id="name1" placeholder="Name 1" maxlength="35">
			<!--<input type="text" name="nickname" class="span4" id="nickname" placeholder="Last Name" maxlength="10">-->
			<input type="text" name="name2" class="span6" id="name2" placeholder="Name 2" maxlength="35">
		...
		<div class="control-group">
		    ...
		    <div class="controls">
			<input type="text" name="search1" class="span6" id="search1" placeholder="Search Term 1" maxlength="10">
			<input type="text" name="search2" class="span6" id="search2" placeholder="Search Term 2" maxlength="10">
		    </div>
		</div>
		<div class="control-group">
		    <label class="control-label"><b>Address</b></label>
		    <div class="controls">
			<input type="text" name="address" class="span11" id="address" placeholder="Address 1 (Max 35 Char)" maxlength="35"><br/>
			<input type="text" name="address2" class="span11" id="address2" placeholder="Address 2 (Max 35 Char)" maxlength="35"><br/>
			<input type="text" name="address3" class="span11" id="address3" placeholder="Address 3 (Max 35 Char)" maxlength="35"><br/>
			<input type="text" name="address4" class="span11" id="address4" placeholder="Address 4 (Max 35 Char)" maxlength="35">
		    </div>
		</div>
		<div class="control-group">
		    <label class="control-label"><b>Postal Code | City</b></label>
		    <div class="controls">
			<input type="text" name="postalcode" class="span3" id="postalcode" placeholder="Postal Code" maxlength="5">
			  <input type="text" name="city" class="span3" id="city" placeholder="City" maxlength="35">
			  <input type="checkbox" name="ck1" id="ck1" value="1" onchange="show_nielsen();"> Allow the data at POS (Nielsen ID, Member Card, Industry, Industry Code 1, & Customer Class is required)
		...
		<div class="control-group">
		    ...
		    <div class="controls">
			<input type="text" name="tlp" class="span3" id="tlp" placeholder="Telephone" maxlength="16">
			<input type="text" name="fax" class="span3" id="fax" placeholder="Fax" maxlength="30">
			<input type="text" name="hp" class="span3" id="hp" placeholder="Mobile Phone" maxlength="16">
			<input type="text" name="email" class="span3" id="email" placeholder="Email" maxlength="30">
		    </div>
		</div>
		<div class="control-group">
		    <label class="control-label"><b>Member Card | VAT Reg.</b></label>
		    <div class="controls">
		      <input type="text" name="membercard" class="span6" id="membercard" placeholder="Member Card" maxlength="30">
		      <input type="text" name="vat" class="span6" id="vat" placeholder="VAT. Reg. No." maxlength="20">
		    </div>
		</div>
		<div class="control-group">
	  ...
	  <div class="row-fluid">
		...
		<div class="row-fluid">
		  <div class="span12"> <!--start span 4-->
		      ...
		      <br/><br/>
		      <input type="button" name="btnAdd" id="btnAdd" value="Save Contact Person" class="btn btn-primary pull-right">
		     <br/><br/>
		  </div>
